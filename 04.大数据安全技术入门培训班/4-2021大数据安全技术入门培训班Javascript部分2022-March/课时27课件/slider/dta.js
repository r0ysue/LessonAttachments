...
DTASlider[_0xe854f9('0x1be')]['_0x371e68'] = new Date()[_0xe854f9('0x19d')](), DTASlider[_0xe854f9('0x1be')][_0xe854f9('0x1e4')] = function () {
  ...
  document[_0x1b815a('0x1f4') + _0x1b815a(0x1f1)](_0x1b815a(0x206) + _0x1b815a('0x1a2') + _0x1b815a('0x1bb'))[_0x1b815a('0x1ce') + _0x1b815a(0x1cd)]('mousemove', _0x1b7074 => {
    ...
    document[_0x46abe3(0x1f4) + _0x46abe3('0x1f1')](_0x3d4f1d[_0x46abe3(0x1_8d)])[_0x46abe3('0x19c')][_0x46abe3('0x1c5')] = _0x3d4f1d[_0x46abe3('0x1fe')](_0x623857, 'px'), document['querySelec' + _0x46abe3('0x1f1')](_0x3d4f1d['_0x233514'])[_0x46abe3('0x19c')][_0x46abe3('0x1c5')] = _0x623857 + 'px', document[_0x46abe3('0x1f4') + _0x46abe3(0x1f1)](_0x3d4f1d[_0x46abe3(0x1e8)])[_0x46abe3('0x19c')][_0x46abe3(0x1b0)] = _0x3d4f1d['_0x3fba9d'](_0x623857, 'px'), this[_0x46abe3('0x211')](this[_0x46abe3('0x1d9')](_0x623857), this[_0x46abe3('0x1d9')](_0x44a94d), this['_0x8ac94c'](_0x2f4f5e), _0x33a72f);
...
Date.prototype.getTime = function (){
  var result = _getTime.apply(this, arguments)
  console.log(result)
  return result
}

function dtaslide(trail){
  let dtaslider = new DTASlider
  dtaslider.start()
  ...
  //   clientY: 0
  // }
  // var mousedownEvent = new Proxy(mousedownEvent, getObjhandler("mousedown"));
  // mousemoveEvent = {
  //   type: "mousemove",
  //   clientX: 0,
  //   clientY: 0
  // }
  // var mousemoveEvent = new Proxy(mousemoveEvent, getObjhandler("mousemove"));
  // mouseupEvent = {
  //   type: "mouseup",
  //   clientX: 0,
  //   clientY: 0
  // }
  // var mouseupEvent = new Proxy(mouseupEvent, getObjhandler("mouseup"));
  // sliderDiv.dispatchEvent(mousedownEvent)
  // sliderDiv.dispatchEvent(mousemoveEvent)
  // sliderDiv.dispatchEvent(mouseupEvent)
  for (let i = 0; i < trail.length; i++) {
    let mytime = trail[i].time
    Date.prototype.getTime = function (){
      var result = startTime + mytime
      console.log(result)
      return result
    }
    sliderDiv.dispatchEvent(trail[i])
  }
  Date.prototype.getTime = _getTime
  return window.result
}
var trail = [{'type': 'mousedown', 'clientX': 26, 'clientY': 290, 'time': 186}, {'type': 'mousemove', 'clientX': 26, 'clientY': 290, 'time': 186}, {'type': 'mousemove', 'clientX': 28, 'clientY': 290, 'time': 203}, {'type': 'mousemove', 'clientX': 35, 'clientY': 290, 'time': 222}, {'type': 'mousemove', 'clientX': 42, 'clientY': 290, 'time': 239}, {'type': 'mousemove', 'clientX': 47, 'clientY': 290, 'time': 257}, {'type': 'mousemove', 'clientX': 52, 'clientY': 290, 'time': 273}, {'type': 'mousemove', 'clientX': 60, 'clientY': 291, 'time': 291}, {'type': 'mousemove', 'clientX': 62, 'clientY': 291, 'time': 310}, {'type': 'mousemove', 'clientX': 68, 'clientY': 291, 'time': 328}, {'type': 'mousemove', 'clientX': 71, 'clientY': 291, 'time': 347}, {'type': 'mousemove', 'clientX': 75, 'clientY': 291, 'time': 366}, {'type': 'mousemove', 'clientX': 77, 'clientY': 291, 'time': 382}, {'type': 'mousemove', 'clientX': 80, 'clientY': 292, 'time': 399}, {'type': 'mousemove', 'clientX': 85, 'clientY': 292, 'time': 418}, {'type': 'mousemove', 'clientX': 88, 'clientY': 292, 'time': 436}, {'type': 'mousemove', 'clientX': 89, 'clientY': 292, 'time': 452}, {'type': 'mousemove', 'clientX': 93, 'clientY': 292, 'time': 468}, {'type': 'mousemove', 'clientX': 96, 'clientY': 292, 'time': 483}, {'type': 'mousemove', 'clientX': 97, 'clientY': 293, 'time': 500}, {'type': 'mousemove', 'clientX': 100, 'clientY': 293, 'time': 515}, {'type': 'mousemove', 'clientX': 103, 'clientY': 293, 'time': 531}, {'type': 'mousemove', 'clientX': 104, 'clientY': 293, 'time': 549}, {'type': 'mousemove', 'clientX': 105, 'clientY': 293, 'time': 567}, {'type': 'mousemove', 'clientX': 106, 'clientY': 293, 'time': 586}, {'type': 'mousemove', 'clientX': 108, 'clientY': 294, 'time': 604}, {'type': 'mousemove', 'clientX': 109, 'clientY': 294, 'time': 622}, {'type': 'mousemove', 'clientX': 110, 'clientY': 294, 'time': 639}, {'type': 'mousemove', 'clientX': 111, 'clientY': 294, 'time': 655}, {'type': 'mousemove', 'clientX': 112, 'clientY': 294, 'time': 672}, {'type': 'mousemove', 'clientX': 112, 'clientY': 294, 'time': 689}, {'type': 'mousemove', 'clientX': 115, 'clientY': 295, 'time': 708}, {'type': 'mousemove', 'clientX': 116, 'clientY': 295, 'time': 727}, {'type': 'mousemove', 'clientX': 116, 'clientY': 295, 'time': 747}, {'type': 'mousemove', 'clientX': 116, 'clientY': 295, 'time': 762}, {'type': 'mousemove', 'clientX': 118, 'clientY': 295, 'time': 779}, {'type': 'mousemove', 'clientX': 116, 'clientY': 295, 'time': 794}, {'type': 'mousemove', 'clientX': 117, 'clientY': 296, 'time': 810}, {'type': 'mousemove', 'clientX': 118, 'clientY': 296, 'time': 829}, {'type': 'mousemove', 'clientX': 119, 'clientY': 296, 'time': 844}, {'type': 'mousemove', 'clientX': 119, 'clientY': 296, 'time': 862}, {'type': 'mousemove', 'clientX': 119, 'clientY': 296, 'time': 878}, {'type': 'mousemove', 'clientX': 119, 'clientY': 296, 'time': 894}, {'type': 'mousemove', 'clientX': 120, 'clientY': 297, 'time': 910}, {'type': 'mousemove', 'clientX': 121, 'clientY': 297, 'time': 928}, {'type': 'mousemove', 'clientX': 121, 'clientY': 297, 'time': 944}, {'type': 'mousemove', 'clientX': 119, 'clientY': 297, 'time': 959}, {'type': 'mousemove', 'clientX': 119, 'clientY': 297, 'time': 974}, {'type': 'mousemove', 'clientX': 120, 'clientY': 297, 'time': 993}, {'type': 'mousemove', 'clientX': 119, 'clientY': 298, 'time': 1013}, {'type': 'mousemove', 'clientX': 119, 'clientY': 298, 'time': 1029}, {'type': 'mousemove', 'clientX': 120, 'clientY': 298, 'time': 1048}, {'type': 'mousemove', 'clientX': 120, 'clientY': 298, 'time': 1066}, {'type': 'mousemove', 'clientX': 120, 'clientY': 298, 'time': 1084}, {'type': 'mousemove', 'clientX': 121, 'clientY': 298, 'time': 1103}, {'type': 'mousemove', 'clientX': 121, 'clientY': 299, 'time': 1120}, {'type': 'mousemove', 'clientX': 120, 'clientY': 299, 'time': 1140}, {'type': 'mousemove', 'clientX': 120, 'clientY': 299, 'time': 1157}, {'type': 'mousemove', 'clientX': 120, 'clientY': 299, 'time': 1175}, {'type': 'mousemove', 'clientX': 120, 'clientY': 299, 'time': 1192}, {'type': 'mousemove', 'clientX': 121, 'clientY': 299, 'time': 1208}, {'type': 'mousemove', 'clientX': 120, 'clientY': 300, 'time': 1226}, {'type': 'mousemove', 'clientX': 120, 'clientY': 300, 'time': 1242}, {'type': 'mousemove', 'clientX': 119, 'clientY': 300, 'time': 1262}, {'type': 'mousemove', 'clientX': 120, 'clientY': 300, 'time': 1278}, {'type': 'mousemove', 'clientX': 121, 'clientY': 300, 'time': 1296}, {'type': 'mousemove', 'clientX': 120, 'clientY': 300, 'time': 1315}, {'type': 'mousemove', 'clientX': 120, 'clientY': 301, 'time': 1331}, {'type': 'mousemove', 'clientX': 121, 'clientY': 301, 'time': 1347}, {'type': 'mousemove', 'clientX': 121, 'clientY': 301, 'time': 1363}, {'type': 'mousemove', 'clientX': 120, 'clientY': 301, 'time': 1381}, {'type': 'mousemove', 'clientX': 121, 'clientY': 301, 'time': 1383}, {'type': 'mousemove', 'clientX': 121, 'clientY': 302, 'time': 1427}, {'type': 'mouseup', 'clientX': 121, 'clientY': 302, 'time': 1427}]

console.log(dtaslide(trail))
