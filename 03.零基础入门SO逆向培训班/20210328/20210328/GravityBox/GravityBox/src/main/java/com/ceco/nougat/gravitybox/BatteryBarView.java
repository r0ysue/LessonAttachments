...
import com.ceco.nougat.gravitybox.ProgressBarController.Mode;
import com.ceco.nougat.gravitybox.ProgressBarController.ProgressInfo;
...
public class BatteryBarView extends View implements IconManagerListener,
    ...
    private void update() {
        if (mEnabled && (mCharging || !mChargingOnly) &&
                !mHiddenByProgressBar && isValidStatusBarState()) {
