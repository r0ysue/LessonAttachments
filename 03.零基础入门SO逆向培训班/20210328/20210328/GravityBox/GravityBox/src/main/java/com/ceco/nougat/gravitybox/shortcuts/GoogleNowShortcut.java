...
public class GoogleNowShortcut extends AShortcut {
    protected static final String ACTION =  ModStatusBar.ACTION_START_SEARCH_ASSIST;

    public GoogleNowShortcut(Context context) {
        super(context);
    }

    @Override
    public String getText() {
        return mContext.getString(R.string.shortcut_google_now);
    }

    @Override
    public Drawable getIconLeft() {
        return mContext.getDrawable(R.drawable.shortcut_google_now);
    }
