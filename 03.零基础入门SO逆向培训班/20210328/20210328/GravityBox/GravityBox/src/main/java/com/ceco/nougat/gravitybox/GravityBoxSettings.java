...
import com.ceco.nougat.gravitybox.ledcontrol.LedMainActivity;
...
import com.ceco.nougat.gravitybox.webserviceclient.TransactionResult;
import com.ceco.nougat.gravitybox.webserviceclient.WebServiceClient;
import com.ceco.nougat.gravitybox.webserviceclient.TransactionResult.TransactionStatus;
import com.ceco.nougat.gravitybox.webserviceclient.WebServiceClient.WebServiceTaskListener;
...
public class GravityBoxSettings extends GravityBoxActivity implements GravityBoxResultReceiver.Receiver {
    ...
    public static final String PREF_KEY_QUICK_SETTINGS_TILES_PER_HEADER = "pref_qs_tiles_per_header";
    ...
    public static final String EXTRA_QS_COLS_HEADER = "qsColsHeader";
    ...
    public static final String PREF_KEY_BATTERY_BAR_LOCKSCREEN_ONLY = "pref_battery_bar_lockscreen_only";
    ...
    public static final String EXTRA_BBAR_LOCKSCREEN_ONLY = "batteryBarLockscreenOnly";
...
//            PREF_KEY_HEADS_UP_SNOOZE_TIMER
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Utils.isAppInstalled(this, "com.ceco.marshmallow.gravitybox")) {
            ...
            .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    Uri oldGbUri = Uri.parse("package:com.ceco.marshmallow.gravitybox");
    ...
    public static class PrefsFragment extends PreferenceFragment 
        ...
        private void initFingerprintLauncher() {
            ...
            for (int i = 0; i < sSystemProperties.fingerprintIds.length; i++) {
                ...
                appPref.setKey(key);
                appPref.setTitle(String.format(Locale.getDefault(), "%s %d",
...
//            }
        ...
        public void onSharedPreferenceChanged(SharedPreferences prefs, String key) {
            ...
            if (key.equals(PREF_KEY_BATTERY_STYLE)) {
            ...
            } else if (key.equals(PREF_KEY_QUICK_SETTINGS_TILES_PER_HEADER)) {
                intent.setAction(ACTION_PREF_QUICKSETTINGS_CHANGED);
                intent.putExtra(EXTRA_QS_COLS_HEADER, Integer.valueOf(prefs.getString(key, "0")));
                ...
                if (!enable) {
                    prefs.edit().putBoolean(PREF_KEY_NAVBAR_CUSTOM_KEY_SWAP, false).commit();
                ...
                getActivity().getPackageManager().setComponentEnabledSetting(
                        new ComponentName(getActivity(), "com.ceco.nougat.gravitybox.GravityBoxSettingsAlias"),
            ...
            } else if (key.equals(PREF_KEY_BATTERY_BAR_LOCKSCREEN_ONLY)) {
                intent.setAction(ACTION_PREF_BATTERY_BAR_CHANGED);
                intent.putExtra(EXTRA_BBAR_LOCKSCREEN_ONLY, prefs.getBoolean(key, false));
            ...
            } else if (key.equals(PREF_KEY_VISUALIZER_DIM_HEADER)) {
                intent.setAction(ACTION_VISUALIZER_SETTINGS_CHANGED);
                intent.putExtra(EXTRA_VISUALIZER_DIM_HEADER, prefs.getBoolean(key, true));
            } else if (key.equals(PREF_KEY_VISUALIZER_DIM_CONTROLS)) {
                intent.setAction(ACTION_VISUALIZER_SETTINGS_CHANGED);
                intent.putExtra(EXTRA_VISUALIZER_DIM_CONTROLS, prefs.getBoolean(key, true));
