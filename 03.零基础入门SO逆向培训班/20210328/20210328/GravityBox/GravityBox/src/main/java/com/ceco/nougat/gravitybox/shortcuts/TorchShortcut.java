...
public class TorchShortcut extends AShortcut {
    protected static final String ACTION =  ModHwKeys.ACTION_TOGGLE_TORCH;

    public TorchShortcut(Context context) {
        super(context);
    }

    @Override
    public String getText() {
        return mContext.getString(R.string.hwkey_action_torch);
    }
