...
public class SleepShortcut extends AShortcut {
    protected static final String ACTION =  ModHwKeys.ACTION_SLEEP;

    public SleepShortcut(Context context) {
        super(context);
    }

    @Override
    public String getText() {
        return mContext.getString(R.string.hwkey_action_sleep);
    }
